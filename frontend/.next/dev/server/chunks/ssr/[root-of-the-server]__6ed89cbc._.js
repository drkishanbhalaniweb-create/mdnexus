...
"[project]/frontend/pages/admin/blog/index.js [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const Blog = ()=>{
    ...
    const fetchPosts = async ()=>{
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$supabase$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["supabase"].from('blog_posts').select('*').order('published_at', {
                ascending: false
            });
            ...
            __TURBOPACK__imported__module__$5b$externals$5d2f$sonner__$5b$external$5d$__$28$sonner$2c$__esm_import$2c$__$5b$project$5d2f$frontend$2f$node_modules$2f$sonner$29$__["toast"].error('Failed to load blog posts');
        } finally{
            setLoading(false);
        }
    };
    const togglePublished = async (id, currentStatus)=>{
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$supabase$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["supabase"].from('blog_posts').update({
            ...
            __TURBOPACK__imported__module__$5b$externals$5d2f$sonner__$5b$external$5d$__$28$sonner$2c$__esm_import$2c$__$5b$project$5d2f$frontend$2f$node_modules$2f$sonner$29$__["toast"].success('Post updated');
        } catch (error) {
            console.error('Error updating post:', error);
            __TURBOPACK__imported__module__$5b$externals$5d2f$sonner__$5b$external$5d$__$28$sonner$2c$__esm_import$2c$__$5b$project$5d2f$frontend$2f$node_modules$2f$sonner$29$__["toast"].error('Failed to update post');
        }
    };
    const deletePost = async (id)=>{
        ...
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$supabase$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["supabase"].from('blog_posts').delete().eq('id', id);
            if (error) throw error;
            setPosts(posts.filter((p)=>p.id !== id));
            __TURBOPACK__imported__module__$5b$externals$5d2f$sonner__$5b$external$5d$__$28$sonner$2c$__esm_import$2c$__$5b$project$5d2f$frontend$2f$node_modules$2f$sonner$29$__["toast"].success('Post deleted successfully');
        } catch (error) {
            console.error('Error deleting post:', error);
            __TURBOPACK__imported__module__$5b$externals$5d2f$sonner__$5b$external$5d$__$28$sonner$2c$__esm_import$2c$__$5b$project$5d2f$frontend$2f$node_modules$2f$sonner$29$__["toast"].error('Failed to delete post');
        }
    };
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("table", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("tbody", {
                                            ...
                                            children: posts.map((post)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("tr", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6ed89cbc._.js.map