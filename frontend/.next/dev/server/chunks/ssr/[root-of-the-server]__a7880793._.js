...
"[project]/frontend/pages/admin/services/edit/[id].js [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const ServiceForm = ()=>{
    ...
    const fetchService = async ()=>{
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$supabase$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["supabase"].from('services').select('*').eq('id', id).single();
            if (error) throw error;
            setFormData(data);
        } catch (error) {
            console.error('Error fetching service:', error);
            __TURBOPACK__imported__module__$5b$externals$5d2f$sonner__$5b$external$5d$__$28$sonner$2c$__esm_import$2c$__$5b$project$5d2f$frontend$2f$node_modules$2f$sonner$29$__["toast"].error('Failed to load service');
        }
    };
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$supabase$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["supabase"].from('services').update(dataToSave).eq('id', id);
            if (error) throw error;
            __TURBOPACK__imported__module__$5b$externals$5d2f$sonner__$5b$external$5d$__$28$sonner$2c$__esm_import$2c$__$5b$project$5d2f$frontend$2f$node_modules$2f$sonner$29$__["toast"].success('Service updated successfully!');
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a7880793._.js.map