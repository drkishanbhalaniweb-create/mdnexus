...
"[project]/frontend/pages/admin/diagnostics.js [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
[__TURBOPACK__imported__module__$5b$externals$5d2f$sonner__$5b$external$5d$__$28$sonner$2c$__esm_import$2c$__$5b$project$5d2f$frontend$2f$node_modules$2f$sonner$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$components$2f$admin$2f$AdminLayout$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
...
const Diagnostics = ()=>{
    ...
    const [filter, setFilter] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])('all'); // all, converted, not_converted
    const [dateRange, setDateRange] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])('7'); // days
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        fetchDiagnostics();
    }, [
        filter,
    ...
    const fetchDiagnostics = async ()=>{
        try {
            ...
            let query = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$supabase$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["supabase"].from('diagnostic_sessions').select('*').gte('created_at', startDate.toISOString()).order('created_at', {
                ascending: false
            });
            ...
            __TURBOPACK__imported__module__$5b$externals$5d2f$sonner__$5b$external$5d$__$28$sonner$2c$__esm_import$2c$__$5b$project$5d2f$frontend$2f$node_modules$2f$sonner$29$__["toast"].error('Failed to load diagnostic data');
        } finally{
            setLoading(false);
        }
    };
    const calculateStats = (data)=>{
        ...
        const avgScore = total > 0 ? (data.reduce((sum, s)=>sum + (s.total_score || 0), 0) / total).toFixed(1) : 0;
    ...
    const getRecommendationColor = (category)=>{
        const rec = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$diagnosticConfig$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["RECOMMENDATIONS"][category];
    ...
    const handleReset = async ()=>{
        ...
        try {
            ...
            const { data: records, error: fetchError } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$supabase$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["supabase"].from('diagnostic_sessions').select('id');
            if (fetchError) throw fetchError;
            if (!records || records.length === 0) {
                __TURBOPACK__imported__module__$5b$externals$5d2f$sonner__$5b$external$5d$__$28$sonner$2c$__esm_import$2c$__$5b$project$5d2f$frontend$2f$node_modules$2f$sonner$29$__["toast"].success('No data to reset.');
                setLoading(false);
                return;
            }
            const idsToDelete = records.map((r)=>r.id);
            // 2. Delete by ID list
            const { error: deleteError } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$supabase$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["supabase"].from('diagnostic_sessions').delete().in('id', idsToDelete);
            if (deleteError) throw deleteError;
            __TURBOPACK__imported__module__$5b$externals$5d2f$sonner__$5b$external$5d$__$28$sonner$2c$__esm_import$2c$__$5b$project$5d2f$frontend$2f$node_modules$2f$sonner$29$__["toast"].success('Diagnostics data has been successfully reset.');
            fetchDiagnostics(); // Refresh to show empty state
        } catch (error) {
            console.error('Error resetting diagnostics:', error);
            __TURBOPACK__imported__module__$5b$externals$5d2f$sonner__$5b$external$5d$__$28$sonner$2c$__esm_import$2c$__$5b$project$5d2f$frontend$2f$node_modules$2f$sonner$29$__["toast"].error(`Failed to reset data: ${error.message || 'Unknown error'}`);
            setLoading(false);
        }
    };
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$components$2f$admin$2f$AdminLayout$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"], {
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$components$2f$SEO$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"], {
                    ...
                    fileName: "[project]/frontend/pages/admin/diagnostics.js",
                    lineNumber: 133,
                    columnNumber: 17
                }, ("TURBOPACK compile-time value", void 0)),
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("p", {
                                            ...
                                            children: "VA Claim Readiness Diagnostic sessions and conversions"
                                        }, void 0, false, {
                                            fileName: "[project]/frontend/pages/admin/diagnostics.js",
                                            lineNumber: 139,
                                            columnNumber: 29
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                                    className: "space-y-3",
                                    children: Object.entries(stats.byRecommendation).map(([category, count])=>{
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("span", {
                                                            ...
                                                            children: getRecommendationLabel(category)
                                                        }, void 0, false, {
                                                            fileName: "[project]/frontend/pages/admin/diagnostics.js",
                                                            lineNumber: 237,
                                                            columnNumber: 45
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                                    ...
                                    children: "Loading diagnostic sessions..."
                                }, void 0, false, {
                                    fileName: "[project]/frontend/pages/admin/diagnostics.js",
                                    lineNumber: 266,
                                    columnNumber: 29
                                }, ("TURBOPACK compile-time value", void 0)) : sessions.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                                    className: "p-8 text-center text-slate-600",
                                    children: "No diagnostic sessions found for the selected filters."
                                }, void 0, false, {
                                    fileName: "[project]/frontend/pages/admin/diagnostics.js",
                                    lineNumber: 270,
                                    columnNumber: 29
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("td", {
                                                                ...
                                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("span", {
                                                                    ...
                                                                    children: getRecommendationLabel(session.recommendation)
                                                                }, void 0, false, {
                                                                    fileName: "[project]/frontend/pages/admin/diagnostics.js",
                                                                    lineNumber: 296,
                                                                    columnNumber: 53
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("td", {
                                                                className: "px-6 py-4 text-sm",
                                                                children: session.converted_to_booking ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("span", {
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("td", {
                                                                className: "px-6 py-4 text-sm text-slate-500 font-mono",
                                                                children: [
...
const __TURBOPACK__default__export__ = Diagnostics;
__turbopack_async_result__();
} catch(e) { __turbopack_async_result__(e); } }, false);}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__38e80365._.js.map