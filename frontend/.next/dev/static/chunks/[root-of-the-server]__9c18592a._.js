...
"[project]/frontend/pages/admin/login.js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const Login = ()=>{
    ...
    const handleLogin = async (e)=>{
        ...
        setError('');
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$supabase$2e$js__$5b$client$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithPassword({
                email,
                password
            });
            if (error) throw error;
            __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["toast"].success('Login successful!');
            router.push('/admin/dashboard');
        } catch (error) {
            console.error('Login error:', error);
            setError(error.message || 'Invalid email or password');
            __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["toast"].error('Login failed');
        } finally{
            setLoading(false);
        }
    };
...
_s(Login, "kJGkpRLrfsH7Iqd9OaF/Hzt3xjw=", false, function() {
    return [
...
"[next]/entry/page-loader.ts { PAGE => \"[project]/frontend/pages/admin/login.js [client] (ecmascript)\" } [client] (ecmascript)", ((__turbopack_context__, module, exports) => {

const PAGE_PATH = "/admin/login";
(window.__NEXT_P = window.__NEXT_P || []).push([
    PAGE_PATH,
    ()=>{
        return __turbopack_context__.r("[project]/frontend/pages/admin/login.js [client] (ecmascript)");
    }
]);
...
"[hmr-entry]/hmr-entry.js { ENTRY => \"[project]/frontend/pages/admin/login.js\" }", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.r("[next]/entry/page-loader.ts { PAGE => \"[project]/frontend/pages/admin/login.js [client] (ecmascript)\" } [client] (ecmascript)");
}),
]);

//# sourceMappingURL=%5Broot-of-the-server%5D__9c18592a._.js.map