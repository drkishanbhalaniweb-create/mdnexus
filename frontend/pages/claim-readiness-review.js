                            ...
                            <div className="border-t border-slate-200 pt-6">
                                <label className="flex items-start cursor-pointer">
                                    ...
                                    <span className="ml-3 text-sm text-slate-700">
                                        I agree to the{' '}
                                        <Link href="/terms" target="_blank" className="text-navy-600 hover:text-navy-700 underline font-semibold">
                                            Terms and Conditions
                                        </Link>
                                        {' '}and{' '}
                                        <Link href="/privacy" target="_blank" className="text-navy-600 hover:text-navy-700 underline font-semibold">
                                            Privacy Policy
                                        </Link>
                                        {' '}*
                                    </span>
