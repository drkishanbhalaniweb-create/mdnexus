...
const AidAttendanceForm = () => {
    ...
    if (submitted) {
        return (
            <Layout>
                <SEO title="Form Submitted - Aid & Attendance" noindex={true} />
    ...
    return (
        <Layout>
            <SEO
                title="Aid & Attendance Evaluation Form"
                description="Comprehensive assessment form for VA Aid & Attendance benefits. Submit your details for a professional medical evaluation by licensed clinicians."
                keywords="Aid and Attendance form, VA pension medical evaluation, Form 21-2680 help, veteran care assessment"
            />
            <div className="min-h-screen bg-gradient-to-br from-navy-50 to-slate-100 py-12">
